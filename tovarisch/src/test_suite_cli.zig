...
const _status_bgp_state_tests = @import("status_bgp_state_tests.zig");
const _status_bgp_error_tests = @import("status_bgp_error_tests.zig");
const _status_bgp_fsm_tests = @import("status_bgp_fsm_tests.zig");
