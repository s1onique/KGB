// commands_test_helpers.zig — Test helpers for CLI commands
//
// Extracted from commands.zig to keep that file under the LLM-friendly line limit.
...
/// Test writer that captures output to a buffer.
pub const CaptureWriter = struct {
    ...
    pub fn writeAll(self: *Self, bytes: []const u8) !void {
        ...
        // MemoryCopySafety: self.buf is a fixed [1024]u8 buffer. bytes is a
