...
func TestBuildServiceCommandUvb76Custom(t *testing.T) {
	r := &Runner{
		cfg: RunConfig{
			...
			DerivedConfigPath:   "/etc/uvb76/production.json",
			Port:                18081,
		},
	}
...
func TestReadinessURL(t *testing.T) {
	tests := []struct {
		...
		// UVB-76 uses HTTPS with self-signed cert generated by prepareUVB76TLS
		{"uvb76", 18081, "https://127.0.0.1:18081/api/v1/status"},
	}
